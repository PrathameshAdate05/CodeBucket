...
Constants {
    ...
    public static final String OpenAI_API = "https://api.openai.com/v1/completions";

    public static final String API_KEY = "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";
